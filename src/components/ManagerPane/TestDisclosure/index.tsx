...
export default function TestDisclosure() {
  const ctx_mdl = useContext(ModalContentDetailsContext);
  const getCourses = useQuery("CoursesContentTEST_FILE", async () => {
    const data = await ContentEndPoints.getByDiscriminator("TEST_FILE");
    return data;
  });
